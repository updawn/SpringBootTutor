...
public class CourseController {
    ...
    @PostMapping(path = "/api/course/addCourse/{inputString}", produces = "application/json")
    public HttpStatus addCourse(@PathVariable("inputString") String inputString) {
    ...
    public HttpStatus deleteCourse(@PathVariable("courseName") String courseName) {
